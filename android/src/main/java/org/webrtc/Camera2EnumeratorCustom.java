...
// copy of Camera2Enumerator.java
public class Camera2EnumeratorCustom implements CameraEnumerator {
    private final static String TAG = "Camera2EnumeratorCustom";
    ...
    public Camera2EnumeratorCustom(Context context) {
    ...
    public CameraVideoCapturer createCapturer(
        ...
        return new Camera2CapturerCustom(context, deviceName, eventsHandler);
    }
